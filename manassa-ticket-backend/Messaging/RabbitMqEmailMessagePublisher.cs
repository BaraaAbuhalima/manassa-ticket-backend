...
public class RabbitMqEmailMessagePublisher(RabbitMqConnectionProvider connectionProvider, IOptions<RabbitMqOptions> options)
    : IEmailMessagePublisher
{
    public async Task PublishAsync(SendEmailMessage message, CancellationToken cancellationToken = default)
    {
        ...
        await channel.BasicPublishAsync(
            ...
            routingKey: options.Value.EmailNotificationQueueName,
            body: body,
